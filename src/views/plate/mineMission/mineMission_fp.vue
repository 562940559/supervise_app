  ...
  <div class="mineMissionWrap">
    <div class="top-wrap">
      ...
      <p>
        ...
        <router-link to="/mineMission_fp" replace>
    ...
    >
      <div class="oneMission-cont">
        ...
        <div @click="goFpDetail(item.id,'distribution')" class="btn">
          <p>分配</p>
        </div>
      </div>
    </div>
...
export default {
  ...
  created() {
    this.$api.mineMission.getMineMissionList_fp()
    .then(res=>{
      this.mineMissionList = res.distributionData;
    })
