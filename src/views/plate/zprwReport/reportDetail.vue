  ...
  <div class="reportWrap">
    ...
    <div class="plateTwo-wrap">
      <div class="plateTwo-cont">
        <div class="onePlate">
          ...
          <div class="text-wrap">
            <p @click="showPop2(reportInfo.taskContent)">查看任务内容<van-icon name="arrow" /></p>
          </div>
        </div>
        <div class="onePlate">
          <div class="img-wrap"><img src="../../../../static/img/mineMission/ckbz.png" alt=""></div>
          <div class="text-wrap">
            <p @click="showPop2(reportInfo.remark)">查看备注<van-icon name="arrow" /></p>
          </div>
        </div>
      </div>
    </div>
    <div class="reportInfo">
      <div class="textareaWrap">
        ...
        <textarea cols="50" disabled v-model="reportInfo.taskWork"></textarea>
      </div>
...
export default {
  ...
  methods: {
    goReportList() {
      ...
      this.$router.push({path: '/coordinationReportList',query: {id: id}})
    },
    showPop2(item) {
      this.showTitle = '';
      this.showText = item;
    ...
    getReportDetail() {
      let id = this.reportId;
      this.$api.zprwReport.getReportDetail(id)
      .then(res => {
        if(res.code == '200') {
          this.reportInfo = res,
