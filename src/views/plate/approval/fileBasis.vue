...
export default {
  ...
  mounted() {
    if(this.$route.query.item.taskFileData) {
      this.fileList = this.$route.query.item.taskFileData;
    }else if(this.$route.query.item.fileData) {
      this.fileList = this.$route.query.item.fileData;
    }else if(this.$route.query.item.documentBasis) {
      this.fileList = this.$route.query.item.documentBasis;
    }else if(this.$route.query.item.attachments) {
      this.fileList = this.$route.query.item.attachments;
    }
  },
  methods: {
    download(file) {
